...
using Content.Shared._NF.Cargo.Components; // Wayfarer: Content.Shared.Cargo.Components<Content.Shared._NF.Cargo.Components
...
public sealed partial class NFCargoConsoleMenu : FancyWindow
{
    ...
    public IEnumerable<CargoProductPrototype> ProductPrototypes
    {
        get
        {
            var allowedGroups = _entityManager.GetComponentOrNull<NFCargoOrderConsoleComponent>(_owner)?.AllowedGroups; // # Wayfarer: CargoOrderConsoleComponent<NFCargoOrderConsoleComponent
