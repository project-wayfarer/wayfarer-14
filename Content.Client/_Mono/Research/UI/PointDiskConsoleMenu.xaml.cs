...
public sealed partial class PointDiskConsoleMenu : FancyWindow
{
    ...
    public event Action? OnPrint50KButtonPressed;
    ...
    public PointDiskConsoleMenu()
    {
        ...
        Print50KButton.OnPressed += _ => OnPrint50KButtonPressed?.Invoke(); /// Wayfarer addition
    }
    ...
    public void Update(PointDiskConsoleBoundUserInterfaceState state)
    {
        ...
        Print50KButton.Disabled = !state.CanPrint50K;
        ...
        Print50KButton.Text = Loc.GetString("point-disk-ui-print-50k-button", ("amount", state.PointCost50K)); /// Wayfarer addition
    }
}
