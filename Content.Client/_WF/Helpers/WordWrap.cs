...
public struct WordWrapHelper
{
    ...
    public WordWrapHelper(float maxSizeX)
    {
        this = default;
        _maxSizeX = maxSizeX;
        LastRune = new Rune('A');
    ...
    public void NextRune(Rune rune, out int? breakLine, out int? breakNewLine, out bool skip, out bool isWordBoundry)
    {
