# Frontier
job-name-bailiff = Master at Arms
job-name-brigmedic = Corpsman
job-name-cadet-nf = Junior Peacekeeper
job-name-contractor = Contractor
job-name-contractor-interview = Contractor Applicant
job-name-deputy = Peacekeeper
job-name-nf-detective = Internal Affairs Agent
