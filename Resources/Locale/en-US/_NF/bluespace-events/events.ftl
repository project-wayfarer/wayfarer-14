...
station-event-bluespace-vault-start-announcement = A Governmental armored vault is inbound to the sector. This is a No Fly Zone for 200 meters around it. Station accounts will be rewarded for its safe return.
...
station-event-bluespace-cache-start-announcement = A Mili-tech weapons cache is inbound to the sector. This is a No Fly Zone for 200 meters around it. Station accounts will be rewarded for guarding the cache.
