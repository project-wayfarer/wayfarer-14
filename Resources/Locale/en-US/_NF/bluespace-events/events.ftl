...
station-event-bluespace-vault-start-announcement = A Governmental armored vault is inbound to the sector. There is a No Fly Zone for 200 meters around it. CGP is authorized to use lethal force on trespassers. Station accounts will be rewarded for its safe return. <#--Wayfarer: Added clause to clarify PVP zone in vault-->
...
station-event-bluespace-cache-start-announcement = A Mili-tech weapons cache is inbound to the sector. There is a No Fly Zone for 200 meters around it. CGP is authorized to use lethal force on trespassers. Station accounts will be rewarded for guarding the cache. <#--Wayfarer: Added clause to clarify PVP zone in vault-->
