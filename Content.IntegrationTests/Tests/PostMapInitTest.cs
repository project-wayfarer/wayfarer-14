        ...
        public async Task AllMapsTested()
        {
            ...
            var gameMaps = protoMan.EnumeratePrototypes<GameMapPrototype>()
                ...
                .Where(x =>
                    ...
                    x.MapPath.ToString().StartsWith("/Maps/_WF")) && // Wayfarer: check wayfarer maps
                    ...
                    !x.MapPath.ToString().StartsWith("/Maps/_WF/Shuttles") && // Wayfarer: skip shuttles (not loaded as maps)
                    !x.MapPath.ToString().StartsWith("/Maps/_WF/POI")) // Wayfarer: skip POIs (not loaded as maps)
                    )
                // End Frontier
                .Select(x => x.ID)
                .ToHashSet();
