...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameMap = CVarDef.Create("game.map", "Dusk", CVar.SERVERONLY); // Wayfarer: Frontier<Dusk
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameMapPool = CVarDef.Create("game.map_pool", "WFMapPool", CVar.SERVERONLY); // Wayfarer: NFMapPool<WFMapPool
