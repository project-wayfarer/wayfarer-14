...
namespace Content.Server._WF.Atmos.EntitySystems;

public sealed class InlineHeatExchangerSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<InlineHeatExchangerComponent, AtmosDeviceUpdateEvent>(OnAtmosUpdate);
    ...
    private void OnAtmosUpdate(EntityUid uid, InlineHeatExchangerComponent comp, ref AtmosDeviceUpdateEvent args)
    {
